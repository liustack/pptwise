...
function buildPrompt(
  ...
  return [
    ...
    "7. Value-label collision: two chart data labels whose boxes intersect is rework. Hide one rather than drawing an ellipsis.",
    "Few-shot images under rubric/examples/ are planted defects. Those pages should score rework or limit.",
    "findings: short English codes (taboo, gravity, text, breathing, theme-independence, strikethrough, overflow, overlap, radius, rotate, axis-title-overlap, label-collision, or L1 codes).",
