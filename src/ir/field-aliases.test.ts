...
function deck(slides: unknown[]) {
  return { version: "5", theme: { id: "brief" }, slides }
}
...
const BLOCK_CASES: readonly BlockCase[] = [
  ...
  { type: "decision_tree", alias: "title", canonical: "question", component: { type: "decision_tree", title: "Buy or build?", branches: [{ edge: "buy", title: "Licence it", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] }, { edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }] }, expected: "Buy or build?" },
  { type: "decision_tree", alias: "decision", canonical: "question", component: { type: "decision_tree", decision: "Buy or build?", branches: [{ edge: "buy", title: "Licence it", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] }, { edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }] }, expected: "Buy or build?" },
  { type: "decision_tree", alias: "options", canonical: "branches", component: { type: "decision_tree", question: "Buy or build?", options: [{ edge: "buy", title: "Licence it", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] }, { edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }] }, expected: [{ edge: "buy", title: "Licence it", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] }, { edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }] },
  ...
  },
  {
    ...
    alias: "for",
    canonical: "pros",
    component: { type: "pros_cons", for: { title: "For", items: [{ label: "Shorter cycle" }, { label: "Lower threshold" }] }, cons: { title: "Against", items: [{ label: "Contracts reopen" }, { label: "Billing rework" }] }, verdict: "Trial it." },
    expected: { title: "For", items: [{ label: "Shorter cycle" }, { label: "Lower threshold" }] },
  },
  {
    type: "pros_cons",
    alias: "against",
    canonical: "cons",
    component: { type: "pros_cons", pros: { title: "For", items: [{ label: "Shorter cycle" }, { label: "Lower threshold" }] }, against: { title: "Against", items: [{ label: "Contracts reopen" }, { label: "Billing rework" }] }, verdict: "Trial it." },
    expected: { title: "Against", items: [{ label: "Contracts reopen" }, { label: "Billing rework" }] },
  },
  {
    type: "pros_cons",
    alias: "conclusion",
    canonical: "verdict",
    component: { type: "pros_cons", pros: { title: "For", items: [{ label: "Shorter cycle" }, { label: "Lower threshold" }] }, cons: { title: "Against", items: [{ label: "Contracts reopen" }, { label: "Billing rework" }] }, conclusion: "Trial it." },
    expected: "Trial it.",
  },
  {
    type: "pros_cons",
    alias: "decision",
    canonical: "verdict",
    component: { type: "pros_cons", pros: { title: "For", items: [{ label: "Shorter cycle" }, { label: "Lower threshold" }] }, cons: { title: "Against", items: [{ label: "Contracts reopen" }, { label: "Billing rework" }] }, decision: "Trial it." },
    expected: "Trial it.",
  },
  {
    ...
    alias: "title",
    canonical: "center",
    component: { type: "segmented_wheel", title: "Customer success", segments: [{ label: "Onboarding" }, { label: "Activation" }, { label: "Health check" }, { label: "Renewal" }] },
  ...
  },
  {
    ...
    alias: "hub",
    canonical: "center",
    component: { type: "segmented_wheel", hub: "Customer success", segments: [{ label: "Onboarding" }, { label: "Activation" }, { label: "Health check" }, { label: "Renewal" }] },
    expected: "Customer success",
  },
  {
    type: "segmented_wheel",
    alias: "whole",
    canonical: "center",
    component: { type: "segmented_wheel", whole: "Customer success", segments: [{ label: "Onboarding" }, { label: "Activation" }, { label: "Health check" }, { label: "Renewal" }] },
    expected: "Customer success",
  },
  {
    type: "segmented_wheel",
    alias: "items",
    canonical: "segments",
    component: { type: "segmented_wheel", center: "Customer success", items: [{ label: "Onboarding" }, { label: "Activation" }, { label: "Health check" }, { label: "Renewal" }] },
    expected: [{ label: "Onboarding" }, { label: "Activation" }, { label: "Health check" }, { label: "Renewal" }],
  },
  {
    type: "segmented_wheel",
    alias: "parts",
    canonical: "segments",
    component: { type: "segmented_wheel", center: "Customer success", parts: [{ label: "Onboarding" }, { label: "Activation" }, { label: "Health check" }, { label: "Renewal" }] },
    expected: [{ label: "Onboarding" }, { label: "Activation" }, { label: "Health check" }, { label: "Renewal" }],
  },
  {
    ...
    alias: "terms",
    canonical: "operands",
    component: { type: "concept_equation", terms: [{ label: "Onboarding" }, { label: "Activation" }], result: { label: "Renewal" } },
    expected: [{ label: "Onboarding" }, { label: "Activation" }],
  },
  {
    type: "concept_equation",
    alias: "factors",
    canonical: "operands",
    component: { type: "concept_equation", factors: [{ label: "Onboarding" }, { label: "Activation" }], result: { label: "Renewal" } },
    expected: [{ label: "Onboarding" }, { label: "Activation" }],
  },
  {
    type: "concept_equation",
    alias: "inputs",
    canonical: "operands",
    component: { type: "concept_equation", inputs: [{ label: "Onboarding" }, { label: "Activation" }], result: { label: "Renewal" } },
    expected: [{ label: "Onboarding" }, { label: "Activation" }],
  },
  {
    type: "concept_equation",
    alias: "output",
    canonical: "result",
    component: { type: "concept_equation", operands: [{ label: "Onboarding" }, { label: "Activation" }], output: { label: "Renewal" } },
    expected: { label: "Renewal" },
  },
  {
    type: "positioning_map",
    alias: "items",
    canonical: "points",
    component: { type: "positioning_map", x_axis: { title: "Depth", low: "Light", high: "Deep" }, y_axis: { title: "Value", low: "Low", high: "High" }, items: [{ label: "Northwind", x: 78, y: 82 }, { label: "Contoso", x: 88, y: 60 }, { label: "Fabrikam", x: 30, y: 74 }, { label: "Tailspin", x: 20, y: 24 }] },
    expected: [{ label: "Northwind", x: 78, y: 82 }, { label: "Contoso", x: 88, y: 60 }, { label: "Fabrikam", x: 30, y: 74 }, { label: "Tailspin", x: 20, y: 24 }],
  },
  {
    type: "positioning_map",
    alias: "entries",
    canonical: "points",
    component: { type: "positioning_map", x_axis: { title: "Depth", low: "Light", high: "Deep" }, y_axis: { title: "Value", low: "Low", high: "High" }, entries: [{ label: "Northwind", x: 78, y: 82 }, { label: "Contoso", x: 88, y: 60 }, { label: "Fabrikam", x: 30, y: 74 }, { label: "Tailspin", x: 20, y: 24 }] },
    expected: [{ label: "Northwind", x: 78, y: 82 }, { label: "Contoso", x: 88, y: 60 }, { label: "Fabrikam", x: 30, y: 74 }, { label: "Tailspin", x: 20, y: 24 }],
  },
  {
    type: "fishbone",
    alias: "result",
    canonical: "effect",
    component: { type: "fishbone", result: "Renewals stalled", ribs: [{ label: "People", causes: ["Load", "Ramp"] }, { label: "Process", causes: ["No escalation", "Split calendars"] }, { label: "Tools", causes: ["Apart", "Manual"] }, { label: "Data", causes: ["Team only", "Late"] }] },
    expected: "Renewals stalled",
  },
  {
    type: "fishbone",
    alias: "problem",
    canonical: "effect",
    component: { type: "fishbone", problem: "Renewals stalled", ribs: [{ label: "People", causes: ["Load", "Ramp"] }, { label: "Process", causes: ["No escalation", "Split calendars"] }, { label: "Tools", causes: ["Apart", "Manual"] }, { label: "Data", causes: ["Team only", "Late"] }] },
    expected: "Renewals stalled",
  },
  {
    type: "fishbone",
    alias: "categories",
    canonical: "ribs",
    component: { type: "fishbone", effect: "Renewals stalled", categories: [{ label: "People", causes: ["Load", "Ramp"] }, { label: "Process", causes: ["No escalation", "Split calendars"] }, { label: "Tools", causes: ["Apart", "Manual"] }, { label: "Data", causes: ["Team only", "Late"] }] },
    expected: [{ label: "People", causes: ["Load", "Ramp"] }, { label: "Process", causes: ["No escalation", "Split calendars"] }, { label: "Tools", causes: ["Apart", "Manual"] }, { label: "Data", causes: ["Team only", "Late"] }],
  },
  {
    type: "venn",
    alias: "intersection",
    canonical: "center",
    component: { type: "venn", intersection: "Both", sets: [{ label: "A" }, { label: "B" }] },
    expected: "Both",
  },
  {
    type: "venn",
    alias: "overlap",
    canonical: "center",
    component: { type: "venn", overlap: "Both", sets: [{ label: "A" }, { label: "B" }] },
    expected: "Both",
  },
]
...
const ITEM_CASES: readonly ItemCase[] = [
  ...
  },
  {
    ...
    alias: "quote",
    canonical: "text",
    item: { quote: "It halved our onboarding.", name: "Sarah Chen" },
    pad: [{ text: "We stopped guessing.", name: "李蔚" }],
    expected: "It halved our onboarding.",
  },
  {
    type: "quote_wall",
    itemsKey: "quotes",
    alias: "author",
    canonical: "name",
    item: { text: "It halved our onboarding.", author: "Sarah Chen" },
    pad: [{ text: "We stopped guessing.", name: "李蔚" }],
    expected: "Sarah Chen",
  },
  {
    ...
    alias: "speaker",
    canonical: "name",
    item: { text: "It halved our onboarding.", speaker: "Sarah Chen" },
    pad: [{ text: "We stopped guessing.", name: "李蔚" }],
    expected: "Sarah Chen",
  },
  {
    ...
    alias: "title",
    canonical: "role",
    item: { text: "It halved our onboarding.", name: "Sarah Chen", title: "Customer Success" },
    pad: [{ text: "We stopped guessing.", name: "李蔚" }],
    expected: "Customer Success",
  },
  {
  ...
  },
  {
    ...
    alias: "label",
    canonical: "title",
    item: { edge: "buy", label: "Licence it", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] },
    pad: [{ edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }],
  ...
  },
  {
    ...
    alias: "name",
    canonical: "title",
    item: { edge: "buy", name: "Licence it", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] },
    pad: [{ edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }],
    extra: { question: "Buy or build?" },
    expected: "Licence it",
  },
  {
    ...
    alias: "condition",
    canonical: "edge",
    item: { condition: "buy", title: "Licence it", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] },
    pad: [{ edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }],
    extra: { question: "Buy or build?" },
    expected: "buy",
  },
  {
    ...
    alias: "desc",
    canonical: "detail",
    item: { edge: "buy", title: "Licence it", desc: "one contract", outcomes: [{ edge: "60%", title: "Standard" }, { edge: "40%", title: "Enterprise" }] },
    pad: [{ edge: "build", title: "Build it", outcomes: [{ edge: "70%", title: "One team" }, { edge: "30%", title: "Two teams" }] }],
    extra: { question: "Buy or build?" },
  ...
  },
  {
    ...
    alias: "title",
    canonical: "label",
    extra: { center: "Customer success" },
    item: { title: "Onboarding" },
    pad: [{ label: "Activation" }, { label: "Health check" }, { label: "Renewal" }],
    expected: "Onboarding",
  },
  {
    type: "segmented_wheel",
  ...
  },
  {
    ...
    alias: "title",
    canonical: "label",
    extra: { result: { label: "Renewal" } },
    item: { title: "Onboarding" },
    pad: [{ label: "Activation" }],
    expected: "Onboarding",
  },
  {
    type: "concept_equation",
  ...
  },
  {
    ...
    canonical: "note",
    extra: { result: { label: "Renewal" } },
    item: { label: "Onboarding", text: "five weeks" },
    pad: [{ label: "Activation" }],
    expected: "five weeks",
  },
  {
    ...
    canonical: "note",
    extra: { result: { label: "Renewal" } },
    item: { label: "Onboarding", desc: "five weeks" },
    pad: [{ label: "Activation" }],
    expected: "five weeks",
  },
  {
    ...
    alias: "title",
    canonical: "label",
    extra: { x_axis: { title: "Depth", low: "Light", high: "Deep" }, y_axis: { title: "Value", low: "Low", high: "High" } },
    item: { title: "Northwind", x: 78, y: 82 },
    pad: [{ label: "Contoso", x: 88, y: 60 }, { label: "Fabrikam", x: 30, y: 74 }, { label: "Tailspin", x: 20, y: 24 }],
    expected: "Northwind",
  },
  {
    type: "positioning_map",
  ...
  },
  {
    ...
    alias: "title",
    canonical: "label",
    extra: { effect: "Renewals stalled" },
    item: { title: "People", causes: ["Load", "Ramp"] },
    pad: [{ label: "Process", causes: ["No escalation", "Split calendars"] }, { label: "Tools", causes: ["Apart", "Manual"] }, { label: "Data", causes: ["Team only", "Late"] }],
    expected: "People",
  },
  {
    type: "fishbone",
    ...
    canonical: "label",
    extra: { effect: "Renewals stalled" },
    item: { name: "People", causes: ["Load", "Ramp"] },
    pad: [{ label: "Process", causes: ["No escalation", "Split calendars"] }, { label: "Tools", causes: ["Apart", "Manual"] }, { label: "Data", causes: ["Team only", "Late"] }],
    expected: "People",
  },
  {
    ...
    canonical: "causes",
    extra: { effect: "Renewals stalled" },
    item: { label: "People", items: ["Load", "Ramp"] },
    pad: [{ label: "Process", causes: ["No escalation", "Split calendars"] }, { label: "Tools", causes: ["Apart", "Manual"] }, { label: "Data", causes: ["Team only", "Late"] }],
    expected: ["Load", "Ramp"],
  },
  {
...
describe("total synonym-pair count", () => {
  it("COMPONENT_FIELD_ALIASES + COMPONENT_ITEM_FIELD_ALIASES flatten to exactly 196 pairs", () => {
    ...
    expect(blockCount + itemCount).toBe(196)
  })
})
...
describe("no aliases present: zero change", () => {
  ...
  it("never mutates a deeply frozen input", () => {
    ...
    const input = Object.freeze({ version: "5", theme: Object.freeze({ id: "brief" }), slides })
