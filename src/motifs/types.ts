...
export type MotifId =
  ...
  | "campaign-motif" // 2026-07-13：多彩笔刷涂鸦（rally 专属，memphis 拆分 A）
  | "classroom-motif" // 2026-07-13：第 13 主题 homeroom 专属；2026-08-20 柔和组重设计为「拍纸簿」（装订孔排+铅笔虚线+回形针）。水彩兄弟 motif 已删除
  | "ink-motif" // 2026-07-10：古籍版框+印章+远山（ink 专属新表达）
  | "luxe-motif" // 2026-07-10 全覆盖：烫金细线（luxe 专属）
  | "enterprise-motif" // 2026-07-10 全覆盖：IKB 方块秩序（bulletin 专属）
  | "heritage-motif" // 2026-07-10 全覆盖：典藏纹饰（heritage 专属）
  | "pulse-motif" // 2026-07-28 themes-16 wave T1：细脉搏线+胶囊/细胞圆点簇（clinic 专属，第 14 主题）
  | "terra-motif" // 2026-07-28 themes-16 wave T2：等高线+叶脉/种子点簇（almanac 专属，第 15 主题）
