 ...
 * DecorPiece：`(960,712,120×8)` `(1092,712,60×8)` `(1164,712,20×8)`。
 * 封面 / 内容 / ending 画。章节退让（绿竖标与 HUD 底线是版式结构件）。
 *
 * 安全区（设计板上四条红虚线禁区）：标题区 (96,48,1040×122)、正文区
 * (96,200,1040×420)、页脚 meta 带 (48,664,1184×44)、右下 logo 盒
 * (1120,630,96×40)。三段条 y712-720，在页脚带下沿 y708 之下、logo 盒
 * 底沿 y670 之下，横向不进标题/正文区。
 *
