...
export const layoutDef: LayoutDefinition = {
  ...
  story: {
    ...
    story: "A large opaque chapter number in the main color sits top-left, with the title below it and two full-width hairlines framing the top and bottom. The organization name sits small in the upper right.",
