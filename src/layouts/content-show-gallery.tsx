...
export const layoutDef = {
  ...
  story: {
    ...
    positioning: "Serves photo at one image grid of four to six items. Choose it to present a curated set of images the audience will browse as a collection.",
    audience: "A lookbook review or creative pitch where pictures speak as a group.",
    notFor: "One hero image with text beside it, which belongs in Feature Frame.",
  },
  slideTypes: ["content"],
  slots: [
    { name: "kicker", accepts: [] },
