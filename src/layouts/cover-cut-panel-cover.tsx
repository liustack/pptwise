...
export const layoutDef = {
  ...
  story: {
    name: "Cut Panel",
    story: "A diagonal-cut trapezoid panel sits on the left carrying the title, with a bright highlight strip along the cut edge. The right half of the page stays open.",
    ...
    notFor: "Covers that need two full-width title lines or a centered axis, which belong on Chalk Band or Double Frame.",
  },
  slideTypes: ["cover"],
  slots: [
    { name: "kicker", accepts: [] },
