...
export const layoutDef = {
  ...
  story: {
    name: "Ghost Fascicle",
    story: "A highlight fascicle kicker sits in the upper-left, a left-aligned title carries a short highlight rule beneath it, and a roman ghost numeral sinks into the bottom-right at near-invisible opacity.",
    ...
    notFor: "Decks that need a loud curtain between sections, which suit Stage Word or Color Field.",
  },
  slideTypes: ["chapter"],
  slots: [
    { name: "kicker", accepts: [] },
