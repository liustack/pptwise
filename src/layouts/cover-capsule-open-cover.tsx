...
export const layoutDef = {
  ...
  story: {
    name: "Date Card",
    story: "A large left-aligned title on open paper, followed by a bold date line in the main color. The page is mostly white space, letting the title and the date breathe.",
    ...
    notFor: "Covers that need a subtitle or author foot, which belong on Report Card.",
  },
  slideTypes: ["cover"],
  slots: [
    { name: "kicker", accepts: [] },
