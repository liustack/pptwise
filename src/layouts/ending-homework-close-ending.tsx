...
export const layoutDef: LayoutDefinition = {
  ...
  story: {
    name: "Assignment Box",
    story: "A highlight-coloured box at top-left holds a label in reversed type. Up to three task lines stack below, a foot rule marks the boundary, and a preview line sits at the bottom.",
    ...
    notFor: "Closings that list formal conclusions, which belong in Conclusions List with a CONCLUSIONS kicker.",
  },
  slideTypes: ["ending"],
  slots: [
    { name: "kicker", accepts: [] },
