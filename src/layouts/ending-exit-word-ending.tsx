...
export const layoutDef = {
  branding: "none",
  // ending-exit-word-ending.tsx: centered close, tour line,
  ...
  story: {
    name: "Gallery Exit",
    story: "A centered sentence fills the middle, a subtitle guide line sits below, and a short highlight rule runs on the center axis between them. An organization-and-date foot anchors the bottom.",
    ...
    notFor: "Closings that need a full-width rule, which belong in Lead Rule where the line spans the page.",
  },
  slideTypes: ["ending"],
  slots: [
