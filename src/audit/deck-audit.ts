 ...
 * `src/audit` doesn't otherwise depend on `src/pptx` and this file's
 ...
 * in `src/render`: `svg-content.tsx` and every card/list component) — never a
 ...
 * pixel-level contrast audit over image-backed text (`../audit/pixel-audit.ts`)
