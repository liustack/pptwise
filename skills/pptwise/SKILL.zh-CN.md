...
2. `npx --yes --package @liustack/pptwise@0.34.0 pptwise <args>`。
3. `bunx --bun @liustack/pptwise@0.34.0 <args>`。
...
| 可换序的并列项 | `list` | `row_cards`、`icon_cards`、`people_cards` |
| 并排看差异 | `comparison` | `comparison`、`from_to`、`image_compare`、`matrix`、`swot` |
| 有方向的步骤或时间 | `process` | `steps`、`chevron_process`、`staircase`、`swimlane`、`journey_map`、`flowchart`、`timeline`、`roadmap`、`gantt`、`cycle` |
...
| 包含或层级 | `hierarchy` | `architecture`、`bmc`、`five_forces`、`rings`、`hub_spoke`、`decision_tree` |
