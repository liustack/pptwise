...
Twelve components own the whole body: `swot`, `bmc`, `waterfall`, `gantt`, `pest`, `five_forces`, `heatmap`, `sankey`, `harvey_balls`, `scorecard`, `pictogram`, and `word_cloud`. Each must be the page's only component.
